        ...
        <div v-if="show" class="left-4">
            ...
            <div class="w-full relative">
                ...
                <div class="gap gap-6 h-full flex w-full overflow-hidden py-4 pb-0 px-4">
                    <side_chat :samepage="activeTab" :auth="auth" :url="conf.url ? conf.url : '/'" :menus="main_menu" v-if="auth  && showSide" class="sidebar mx-1 bg-white" id="sidebar" style="z-index:99999">
                    </side_chat>
