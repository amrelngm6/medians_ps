            ...
            <main v-if="content && !showLoader" class=" flex-1 overflow-x-hidden overflow-y-auto  w-full">
                ...
                <div class="w-full ">
                    ...
                    <datatabble :body-text-direction="translate('lang') == 'ar' ? 'right' : 'left'" fixed-checkbox v-if="content.columns" :headers="content.columns" :items="content.items" >
                        ...
                        <template #item-students="items">
                            
                            <div class="w-full h-8 relative flex">
                                <div  v-for="(student, i) in item.students" >
                                ...
                                <span class="flex absolute pt-2" :style="'left: '+((20 * (item.students.length < 3 ? item.students.length : 3) ) + 20)+'px'"> <route_icon /><span class="font-semibold  px-1" v-if="item.pickup_locations" v-text="item.pickup_locations.length"></span></span>
                            </div>
