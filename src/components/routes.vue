...
export default 
{
    ...
    methods: 
    {
        ...
        setLocationsPickups(route)
        {
            ...
            locations[locations.length] = {drag:true, icon: this.conf.url+'uploads/images/destination.svg', origin: { lat: parseFloat(route.vehicle.last_latitude), lng: parseFloat(route.vehicle.last_longitude) }, destination: { lat: parseFloat(route.vehicle.last_latitude), lng: parseFloat(route.vehicle.last_longitude) } }
            return locations;
        },  
