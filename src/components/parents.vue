        ...
        <div class=" w-full">
            ...
            <main v-if="content && !showLoader" class=" flex-1 overflow-x-hidden overflow-y-auto  w-full">
                ...
                <div class="w-full flex gap gap-6">
                    ...
                    <side-form-create :conf="conf" model="Parents.create" v-if="showAddSide && content && content.fillable" :columns="content.fillable"  class="col-md-3" />

                    <side-form-update :conf="conf" model="Parents.update" :item="activeItem" :model_id="activeItem.parent_id" index="parent_id" v-if="showEditSide && !showAddSide " :columns="content.fillable"  class="col-md-3" />
    ...
    methods: 
    {
        ...
        handleAction(actionName, data) {
            switch(actionName) 
            {
                ...
                case 'delete':
                    this.$parent.delete(data, 'Parents.delete');
                    break;  
            }
        },
