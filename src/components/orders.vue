<template>
    <div class="w-full " >
        ...
        <order_wizard :currency="currency" @callback="showWizard=false" v-if="showWizard" :key="showWizard" :item="activeItem"   :system_setting="system_setting" :conf="conf" />
...
import order_wizard from '@/components/wizards/orderWizard.vue';
