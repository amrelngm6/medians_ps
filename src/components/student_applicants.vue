<template>
    <div class="w-full flex overflow-auto" >
        ...
        <div  v-if="content " class=" w-full relative">
            ...
            <model_applicant_wizard @callback="showWizard=false" :currency="currency" v-if="showWizard" :key="showWizard"  :system_setting="system_setting" :item="activeItem" :setting="setting" :conf="conf" />
