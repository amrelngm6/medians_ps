<template>
    <div class="w-full" v-if="column" >
        ...
        <select @change="changed(column.data.map(e => e[column.key] == item[column.key]))" :required="column.required" :disabled="column.disabled" v-if="!column.multiple && column.data && column.column_type == 'select'" v-model="item[column.key]"  :name="handleName(column)" :type="column.column_type" class="form-control form-control-solid"   :placeholder="column.title">
