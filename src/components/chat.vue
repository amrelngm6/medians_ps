            ...
            <div class="tyn-chat-form w-full bg-white px-4 pb-4">
                <div class="tyn-chat-form-insert">
                    <ul class="tyn-list-inline gap gap-3">
                        ...
                        <li class="d-none d-sm-block"><button @click="" class="btn btn-icon btn-light btn-md btn-pill">
                                <!-- card-image -->
                        ...
                        <div class="tyn-aside-row">
                            <div class="tab-content">
                                <div class="tab-pane show active" id="chat-media-images" tabindex="0">
                                    <div class="row g-3">
                                        <div class="col-4">
                                            <a href="/uploads/images/1.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="/uploads/images/thumb-1.jpg" class="tyn-image" alt="">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="/uploads/images/2.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="/uploads/images/thumb-2.jpg" class="tyn-image" alt="">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="/uploads/images/3.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="/uploads/images/thumb-3.jpg" class="tyn-image" alt="">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="/uploads/images/4.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="/uploads/images/thumb-4.jpg" class="tyn-image" alt="">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                            <a href="/uploads/images/5.jpg" class="glightbox tyn-thumb" data-gallery="media-photo">
                                                <img src="/uploads/images/thumb-5.jpg" class="tyn-image" alt="">
                                            </a>
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-6">
                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                <img src="/uploads/images/hr-1.jpg" class="tyn-image" alt="">
                                        ...
                                        <div class="col-6">
                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                <img src="/uploads/images/hr-2.jpg" class="tyn-image" alt="">
                                                <div class="tyn-video-icon">
                                                    <!-- play-fill -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                        <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                        ...
                                        <div class="col-6">
                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                <img src="/uploads/images/hr-3.jpg" class="tyn-image" alt="">
                                                <div class="tyn-video-icon">
                                                    <!-- play-fill -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                        <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                        ...
                                        <div class="col-6">
                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                <img src="/uploads/images/hr-4.jpg" class="tyn-image" alt="">
                                                <div class="tyn-video-icon">
                                                    <!-- play-fill -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                        <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
                                        ...
                                        <div class="col-6">
                                            <a href="https://www.youtube.com/watch?v=ag0qTaAKqT8" class="glightbox tyn-video" data-gallery="media-video">
                                                <img src="/uploads/images/vr-5.jpg" class="tyn-image" alt="">
                                                <div class="tyn-video-icon">
                                                    <!-- play-fill -->
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-play-fill" viewBox="0 0 16 16">
                                                        <path d="m11.596 8.697-6.363 3.692c-.54.313-1.233-.066-1.233-.697V4.308c0-.63.692-1.01 1.233-.696l6.363 3.692a.802.802 0 0 1 0 1.393z" />
...
export default {
    ...
    methods: {
        ...
        changeListener($event) {
            ...
            this.$parent.handleRequest( params, '/api/send_image' ).then(response=> {
                this.load()
