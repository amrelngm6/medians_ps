                    ...
                    <div v-for="message in messages" :class="message.income ? 'incoming' : 'outgoing'" class="tyn-reply-item ">
                        <div class="tyn-reply-group">
                            <div class="tyn-reply-bubble" @click="setReadMsg(message.id)">
                                ...
                                <span v-if="message.reply_message && message.reply_message.id" class="p-1 bg-white absolute left-0 bottom-0 w-8 h-8 rounded-full" v-html="message.reply_message.message_emojis" style="max-width: 60%;left: 0px;">
                                    ...
                                    <div v-if="message.reply_message.message_type === 'document' && !message.reply_message.is_video" class="tyn-reply-file">
                                        <a :href="message.reply_message.media_path" target="_blank" class="tyn-file">
                                            <div class="tyn-media-group">
                                                ...
                                                <div class="tyn-media-col">
                                                    <h6 class="name" v-text="message.reply_message.media_title"></h6>
                                                    <div class="meta"  v-text="message.reply_message.media_type"></div>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div v-if="message.reply_message.message_type === 'image' || message.reply_message.message_type === 'sticker' " class="tyn-reply-media">
                                        <a :title="message.reply_message.message_text" :href="message.reply_message.image_path" class="glightbox tyn-thumb cursor-pointer" data-gallery="media-photo">
                                            <img :src="message.reply_message.image_path" class="tyn-image" alt="">
                                        </a>
                                    </div>
                                    ...
                                    <div v-if="message.message_type === 'document' && !message.is_video" class="tyn-reply-file">
                                        <a :href="message.media_path" target="_blank" class="tyn-file">
                                            <div class="tyn-media-group">
                                                ...
                                                <div class="tyn-media-col">
                                                    <h6 class="name" v-text="message.media_title"></h6>
                                                    <div class="meta"  v-text="message.media_type"></div>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
