                            ...
                            <div class="col">
                                <div class="p-2">
                                    ...
                                    <div class="hstack text-muted gap-1">
                                        <div class="me-2"><i class="ri-map-pin-user-line me-1 fs-16 align-bottom text-body"></i>California, United States</div>
                                        <div>
                                            <i class="ri-building-line me-1 fs-16 align-bottom text-body"></i>Themesbrand
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row text text-center">
                                    <div class="col-lg-6 col-4">
                                        <div class="p-2">
                                            ...
                                            <p class="fs-14 text-muted mb-0">Followers</p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-4">
                                        <div class="p-2">
                                            <h4 class="mb-1">1.3K</h4>
                                            <p class="fs-14 text-muted mb-0">Following</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div>
                                                            <div class="d-flex align-items-center py-3">
                                                                ...
                                                                <div class="flex-shrink-0 ms-2">
                                                                    <button type="button" class="btn btn-sm btn-outline-primary"><i class="ri-user-add-line align-middle"></i></button>
                                                                </div>
                                                            </div>
                                                            <div class="d-flex align-items-center py-3">
                                                                <div class="avatar-xs flex-shrink-0 me-3">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="swiper project-swiper mt-n4 swiper-initialized swiper-horizontal swiper-backface-hidden">
                                                            <div class="d-flex justify-content-end gap-2 mb-2">
                                                                <div class="slider-button-prev" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-7eb5d10c5da440ce7" aria-disabled="false">
                                                                    <div class="avatar-title fs-18 rounded px-1">
                                                                        <i class="ri-arrow-left-s-line"></i>
                                                                    </div>
                                                                </div>
                                                                <div class="slider-button-next" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-7eb5d10c5da440ce7" aria-disabled="false">
                                                                    <div class="avatar-title fs-18 rounded px-1">
                                                                        <i class="ri-arrow-right-s-line"></i>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="swiper-wrapper" id="swiper-wrapper-7eb5d10c5da440ce7" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(-347.333px, 0px, 0px);">
                                                                <div class="swiper-slide swiper-slide-prev" role="group" aria-label="1 / 5" style="width: 322.333px; margin-right: 25px;">
                                                                ...
                                                                <!-- end slide item -->
                                                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="2 / 5" style="width: 322.333px; margin-right: 25px;">
                                                                ...
                                                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="3 / 5" style="width: 322.333px; margin-right: 25px;">
                                                                ...
                                                                <div class="swiper-slide" role="group" aria-label="4 / 5" style="width: 322.333px; margin-right: 25px;">
                                                                    <div class="card profile-project-card shadow-none profile-project-danger mb-0">
                                                                        <div class="card-body p-4">
                                                                            <div class="d-flex">
                                                                                <div class="flex-grow-1 text-muted overflow-hidden">
                                                                ...
                                                                <!-- end slide item -->
                                                                <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 322.333px; margin-right: 25px;">
