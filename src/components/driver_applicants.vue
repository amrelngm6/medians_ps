                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-px text-center pt-15 pb-15">
                            ...
                            <p class="text-gray-400 fs-4 font-semibold py-7" v-text="translate('Here you can find the sent driver applicantions to join your team')"></p>
                        </div>
...
import driver_applicant_wizard from '@/components/wizards/driverApplicantWizard.vue';
