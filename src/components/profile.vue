                    ...
                    <div class="card card-flush pt-3 mb-5 mb-xl-10" v-if="activeTab == 'withdrawal'">
                        <div class="card  card-xxl-stretch mb-5 mb-xxl-10">
                            ...
                            <div class="card-body pb-0">
                                <span class="fs-5 fw-semibold text-gray-600 pb-5 d-block" v-text="translate('Here is the wallet debit and credit balance')"></span>
                                    ...
                                    <div class="d-flex flex-wrap">
                                        <div class="border border-dashed border-gray-300 w-125px rounded my-3 p-4 me-6">                    
                                            <span class="fs-2x fw-bold text-gray-800 lh-1" v-if="content.wallet">
                                                <span v-text="content.wallet ? (currency.symbol+''+(content.wallet.credit_balance ?? '0')) : '0'"></span>
                                            </span>
