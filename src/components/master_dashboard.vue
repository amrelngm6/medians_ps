            ...
            <div class="w-full overflow-y-auto overflow-x-hidden px-2 mt-6">
                    ...
                    <div class="card card-flush h-md-50 mb-5 mb-xl-10 w-full">
                            ...
                            <div class="card-title d-flex flex-column">
                                <div class="d-flex align-items-center">
                                    <span class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2"
                                        v-text="content.total_visits"></span>
                                </div>
                                <span class="text-gray-500 pt-1 fw-semibold fs-6"
                                    v-text="translate('Total visits')"></span>
                            </div>
                        </div>
                        ...
                        <div class="px-4 pt-2 pb-4 d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column content-justify-center w-100">
                                <div class="d-flex gap-4 fs-6 fw-semibold align-items-center"
                                    v-for="item in content.top_visits">
                ...
                <div class="">
                    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6 mb-6">
                        <dashboard_card_white icon="/uploads/img/booking-unpaid.png" classes="bg-dark"
                            text_class="fs-4 text-white" value_class="text-white" :title="translate('Doctors Bookings')"
                            :value="content.doctors_bookings_count"></dashboard_card_white>
                        <dashboard_card_white icon="/uploads/img/booking-paid.png" classes="bg-info"
                            text_class="fs-4 text-white" value_class="text-white" :title="translate('Offers Bookings')"
                            :value="content.offers_bookings_count"></dashboard_card_white>
                        <dashboard_card_white icon="/uploads/img/booking_income.png" classes="bg-success"
                            text_class="fs-4 text-white" value_class="text-white"
                            :title="translate('OnlineConsultation Booking')"
                            :value="content.onlineconsultation_bookings_count"></dashboard_card_white>
                        <dashboard_card_white icon="/uploads/img/products_icome.png" classes="bg-danger"
                            text_class="fs-4 text-white" value_class="text-white" :title="translate('Normal Booking')"
                            :value="content.bookings_count"></dashboard_card_white>
                    </div>
                    ...
                    <div class="w-full ">
                        <div class="w-full">
                            ...
                            <div class="w-full bg-white p-4 mb-4 rounded-lg" v-if="content.visits_countries">
                                ...
                                <MapChart :countryData="content.visits_countries" highColor="#0c9ba4" lowColor="#b4dddf"
                                    countryStrokeColor="#eee" defaultCountryFillColor="#dbdfe9" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:flex gap gap-6 pb-6">
                    <div class="card mb-0 w-full lg:w-1/3">
                        ...
                        <div class="w-full p-4">
                            ...
                            <p class="text-sm text-gray-500 px-4 mb-6" v-text="translate('top pages with high views')">
                            </p>
                        </div>
                        <div class="card-body w-full">
                            <div class="w-full" v-if="pie_options">
                                <dashboard_pie_chart v-if="pie_options" type="pie" :key="pie_options"
                                    :options="pie_options" />
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table class="w-full table table-striped table-nowrap custom-table mb-0 datatable">
                                        ...
                                        <tbody v-if="content.top_visits" :key="content.top_visits">
                                            <tr :key="index" v-for="(item, index) in content.top_visits">
                                                ...
                                                <td
                                                    v-text="item && item.item && item.item.title ? item.item.title : item.class">
                                                </td>
                ...
                <div class="lg:flex w-100 gap gap-6">

                    <div class="card  w-full  no-mobile">
                        <div class="w-full flex p-4">
                            <h4 class="w-full " v-text="translate('forum posts')"></h4>
                            <a href="/admin/forum" class="w-20" v-text="translate('View all')"></a>
                        </div>
                        <div class="card-body w-full">
                            <div class="w-full">
                                <div class="table-responsive w-full">
                                    <table class="w-full table table-striped table-nowrap custom-table mb-0 datatable">
                                        ...
                                        <tbody>
                                            <tr :key="index" v-for="(post, index) in content.latest_forum_posts">
                                                ...
                                                <td v-text="post.customer_phone ?? ''"></td>
                                                <td v-text="post.message ?? ''"></td>
                                                <td v-text="post.date"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="card  w-full  no-mobile">
                        <div class="w-full flex p-4">
                            <h4 class="w-full " v-text="translate('Forum comments')"></h4>
                            <a href="/admin/forum" class="w-20" v-text="translate('View all')"></a>
                        </div>
                        <div class="card-body w-full">
                            <div class="w-full">
                                <div class="table-responsive w-full">
                                    <table class="w-full table table-striped table-nowrap custom-table mb-0 datatable">
                                        <thead>
                                            <tr>
                                                <th v-text="translate('#')"></th>
                                                <th v-text="translate('Comment')"></th>
                                                <th v-text="translate('Name')"></th>
                                                <th v-text="translate('Phone')"></th>
                                                <th v-text="translate('Reply')"></th>
                                                <th v-text="translate('date')"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                ...
                <div class="w-full py-10">
                    ...
                    <div class="w-full bg-white p-4 mb-4 rounded-lg" v-if="content.bookings_charts">
                        <dashboard_pie_chart v-if="merge_line_options" type="bar" :key="merge_line_options"
                            :options="merge_line_options" />
                    </div>
                </div>
                                ...
                                <table class="w-full table table-striped table-nowrap custom-table mb-0 datatable">
                                    ...
                                    <tbody>
                                        <tr :key="index" v-for="(booking, index) in content.latest_bookings">
                                            ...
                                            <td
                                                v-text="(booking.field.mobile_key ?? '') + (booking.field.mobile ?? '')">
                                            </td>
