<template>
    <div class="w-full " >
        ...
        <invoice_wizard :currency="currency" @callback="showWizard=false" v-if="showWizard" :key="showWizard" :item="activeItem" :setting="setting"  :system_setting="system_setting" :conf="conf" ></invoice_wizard>
