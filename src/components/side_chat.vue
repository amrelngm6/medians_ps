                                ...
                                <li v-for="contact in content.contacts" :id="'contact'+contact.id" class="my-2 tyn-aside-item js-toggle-main ">
                                    <div class="tyn-media-group">
                                        ...
                                        <div class="tyn-media-col"  v-tooltip="contact.msg && contact.msg.message_emojis ? contact.msg.message_emojis : contact.msg.message_text"  @click="selectContact(contact)" >
                                            ...
                                            <div class="tyn-media-row has-dot-sap" v-if="contact.msg" :class="(contact.msg && !contact.msg.read && contact.msg.income ) ? 'text-green-400' : ''">
                                                ...
                                                <p class="content w-full":class="contact.msg.read ? 'font-normal' : 'font-semibold'" v-if="contact.msg" v-html="contact.msg.message_emojis ? contact.msg.message_emojis : contact.msg.message_text"></p>
                                                <span class="meta" :class="(contact.msg && !contact.msg.read && contact.msg.income) ? 'text-green-400' : ''" v-if="contact.msg" v-html="contact.msg.time_ago"></span>
                                            </div>
                                        </div>
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="tyn-list-links">
                                                            ...
                                                            <li><p class="my-0 px-3 py-2 gap-2 text-sm cursor-pointer flex" @click="joinConversation(contact)">
