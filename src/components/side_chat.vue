                                    ...
                                    <div class="tyn-media-group">
                                        ...
                                        <div class="tyn-media-col" @click="selectContact(contact)" >
                                            ...
                                            <div class="tyn-media-row has-dot-sap" v-if="contact.msg" :class="(contact.msg && !contact.msg.read && contact.msg.income ) ? 'text-green-400' : ''">
                                                ...
                                                <p class="content w-full" v-tooltip="contact.msg.message_emojis ? contact.msg.message_emojis : contact.msg.message_text" :class="contact.msg.read ? 'font-normal' : 'font-semibold'" v-if="contact.msg" v-html="contact.msg.message_emojis ? contact.msg.message_emojis : contact.msg.message_text"></p>
