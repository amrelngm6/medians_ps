    ...
    <nav id="header" class="rounded-lg px-4 flex w-auto bg-white shadow-lg border-b border-gray-300 relative " >
        ...
        <ul class="nav user-menu flex relative">
            ...
            <li v-if="auth && lang"  class="nav-item has-arrow main-drop relative ">
                ...
                <ul class="drop-ul py-4 px-2 w-40 bg-white border border-gray-300 rounded-lg  absolute top-14 left-1 hidden dropped2" style="z-index: 9999;">
            ...
            <li v-if="auth && lang"  class="nav-item  has-arrow main-drop ">
                ...
                <ul class="drop-ul py-4 px-2 w-full bg-white border border-gray-300 rounded-lg  absolute top-14 left-1 hidden " style="z-index: 9999; top:60px">
