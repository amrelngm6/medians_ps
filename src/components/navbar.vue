            ...
            <div class="tyn-appbar-content">
                <ul class="tyn-appbar-nav tyn-appbar-nav-start">
                    <li class="tyn-appbar-item">
                        <a class="tyn-appbar-link relative" href="javascript:;"  v-tooltip="__('Active converssations')"
                            @click='$parent.switchTab({ link: "messages" })'>
                            <!-- chat-text-fill -->
                            ...
                            <div id="new_messages_count"
                                class="badge bg-primary position-absolute rounded-pill top-0 end-0 mt-n1 me-n1"></div>
                            <span class="d-none">Chats</span>
                        </a>
                    </li>
                    <li class="tyn-appbar-item d-sm-inline-flex">
                        <a class="tyn-appbar-link position-relative" href="javascript:;"  v-tooltip="__('New conversations')"
                            ...
                            <div id="new_chats_count"
                                class="badge bg-primary position-absolute rounded-pill top-0 end-0 mt-n1 me-n1"></div>
                            <span class="d-none">New contacts</span>
                        </a>
                    </li>
                </ul><!-- .tyn-appbar-nav -->
                <ul class="tyn-appbar-nav tyn-appbar-nav-end">
                    ...
                    <li class="tyn-appbar-item">
                        ...
                        <a class="d-inline-flex dropdown-toggle" data-bs-auto-close="outside" data-bs-toggle="dropdown"
                            href="#" data-bs-offset="0,10">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <ul class="d-flex align-items-center gap gap-3">
                                            <li class="inline-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="themeMode" id="dark"
                                                        value="dark">
                                            ...
                                            <li class="inline-flex">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="themeMode" id="light"
                                                        value="light" checked>
                            ...
                            <ul class="tyn-list-links hidden" style="display:none">
                                <li>
...
<style lang="css">.has-arrow.main-drop {
    width: max-content
}</style>