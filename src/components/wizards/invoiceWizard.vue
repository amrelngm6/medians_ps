                                                ...
                                                <table class="table mb-3">
                                                    ...
                                                    <tbody v-if="activeItem.items">
                                                        <tr class="fw-bold text-gray-700 fs-5 text-end" v-for="invoiceItem in activeItem.items">
                                                            ...
                                                            <td class="pt-6" v-text="currency.sumbol + '' + invoiceItem.subtotal"></td>
                                                            <td class="pt-6" v-text="currency.sumbol + '' + invoiceItem.discount_amount"></td>
                                                            <td class="pt-6 text-gray-900 fw-bolder" v-text="currency.sumbol + '' + invoiceItem.total_amount "></td>
                                                        </tr>
                                            ...
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <div class="mw-300px">
                                                    <div class="d-flex flex-stack mb-3">
                                                        ...
                                                        <div class="text-end fw-bold fs-6 text-gray-800" v-text="currency.sumbol + '' + activeItem.subtotal "></div>
                                                    </div>
                                                        
                                                    <div class="d-flex flex-stack mb-3">
                                                        <div class="fw-semibold pe-10 text-gray-600 fs-7" v-text="translate('Discount')"></div>
                                                        <div class="text-end fw-bold fs-6 text-gray-800" v-text="currency.sumbol + '' + activeItem.discount_amount"></div>
                                                    </div>
                            
                                                    <div class="d-flex flex-stack mb-3">
                                                        <div class="fw-semibold pe-10 text-gray-600 fs-7" v-text="translate('Total amount')"></div>
                                                        <div class="text-end fw-bold fs-6 text-gray-800" v-text="currency.sumbol + '' + activeItem.total_amount"></div>
                                                    </div>
                            ...
                            <div class="m-0">
                                ...
                                <div v-if="activeItem.transaction"
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <div class="fw-bold text-gray-800 fs-6" v-text="currency.sumbol + '' + activeItem.transaction.amount"></div>
                                    </div>
