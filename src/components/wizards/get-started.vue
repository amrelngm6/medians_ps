                                            ...
                                            <li class="flex py-2" v-if="activePlan.type == 'paid'">
                                                ...
                                                <ul class="flex nav-pills nav-pills-custom mb-3">
                                                    <li class="nav-item mb-3 me-3 me-lg-6" role="presentation">
                                                        <a @click="paymentMethod = 'paystack'"  :class="paymentMethod == 'paypal' ? 'border-black' : ''"  class="nav-link btn btn-outline btn-flex btn-color-muted btn-active-color-primary flex-column overflow-hidden w-80px h-85px pt-5 pb-2 " id="kt_stats_widget_16_tab_link_2"  href="javascript:;" >
