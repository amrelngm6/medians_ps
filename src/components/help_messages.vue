                ...
                <div class="card-body pb-0 px-4">
                    ...
                    <ul class="nav nav-tabs-custom border-bottom-0" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#project-overview" role="tab" aria-selected="false" tabindex="-1">
                                Overview
                            </a>
                        </li>
                        <li class="nav-item" role="presentation">
                        ...
                        <li class="nav-item" role="presentation">
                            <a class="nav-link fw-semibold active" data-bs-toggle="tab" href="#project-team" role="tab" aria-selected="true">
                                Team
                            </a>
                        </li>
                    </ul>
...
<div class="row">
    <div class="col-lg-12">
        <div class="tab-content text-muted">
                    ...
                    <div class="col-xl-9 col-lg-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div data-simplebar="init" style="height: 300px;" class="px-3 mx-n3 mb-2"><div class="simplebar-wrapper" style="margin: 0px -16px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px 16px;">
                                ...
                                </div></div></div></div><div class="simplebar-placeholder" style="width: 0px; height: 0px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar" style="width: 0px; display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: hidden;"><div class="simplebar-scrollbar" style="height: 0px; transform: translate3d(0px, 152px, 0px); display: none;"></div></div></div>
                                <form class="mt-4">
                                    <div class="row g-3">
                                        <div class="col-12">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2 fs-16">
                                    <div class="badge fw-medium bg-primary-subtle text-primary">UI/UX</div>
                                    <div class="badge fw-medium bg-primary-subtle text-primary">Figma</div>
                                    <div class="badge fw-medium bg-primary-subtle text-primary">HTML</div>
                                    <div class="badge fw-medium bg-primary-subtle text-primary">CSS</div>
                                    <div class="badge fw-medium bg-primary-subtle text-primary">Javascript</div>
                                    <div class="badge fw-medium bg-primary-subtle text-primary">C#</div>
                                    <div class="badge fw-medium bg-primary-subtle text-primary">Nodejs</div>
                                </div>
                            </div>
                            <!-- end card body -->
                        </div>
                        ...
                        <div class="card">
                            <div class="card-header align-items-center d-flex border-bottom-dashed">
                                ...
                                <div class="flex-shrink-0">
                                    <button type="button" class="btn btn-soft-secondary btn-sm"><i class="ri-upload-2-fill me-1 align-bottom"></i> Upload</button>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="acitivity-timeline py-3">
                            ...
                            <div class="acitivity-item py-3 d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-1">Nancy Martino <span class="badge bg-secondary-subtle text-primary align-middle">In Progress</span></h6>
                            ...
                            <div class="acitivity-item d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <p class="text-muted mb-2">User <span class="text-primary">Erica245</span> submitted a ticket.</p>
            ...
            <!-- end tab pane -->
            <div class="tab-pane fade active show" id="project-team" role="tabpanel">
...
<!-- end row -->
        ...
        <data_table_page ref="data_table"  :conf="conf" :path="path" :setting="setting" :auth="auth" object_name="HelpMessage" object_key="message_id" ></data_table_page>
    </div>
</template>
<script>
