                                                    ...
                                                    <div class="flex gap-2 mb-4" v-for="comment in item.comments">
                                                        <div class="flex-grow-1 ms-3" v-if="comment.user_name">
                                                            <h5 class="fs-13 flex gap-2">
                                                                ...
                                                                <small class="w-full  text-muted" v-text="comment.date"></small>
                                                                
                                                                <div @click="setCommentStatus(comment)" class="py-4 flex gap gap-2 cursor-pointer flex-none " >
                                                                    ...
                                                                    <span  v-text="comment.status == 'on' ? translate('Active') : translate('Pending')" class="font-semibold inline-flex items-center px-2 py-1 rounded-full text-xs font-medium "></span>
                                                                    <input value="on" :checked="comment.status == 'on'"  type="checkbox" class="hidden" />
                                                                </div>
...
export default
    {
        ...
        setup(props, { emit }) {
            ...
            const setCommentStatus = (comment) => {
                ...
                comment.status = (comment.status == 'on') ? 0 : 'on';
