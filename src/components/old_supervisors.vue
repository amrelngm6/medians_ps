        ...
        <div  v-if="content " class=" w-full relative">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-px text-center pt-15 pb-15">
                            ...
                            <p class="text-gray-400 fs-4 font-semibold py-7" v-text="translate('Add your first Supervisor using this below wizard')"></p>
                            <a v-text="translate('add_new')" @click="addSupervisorWizard" href="javascript:;" class="text-white btn btn-primary er fs-6 px-8 py-4" ></a>
                        </div>
            ...
            <main class=" flex-1 overflow-x-hidden overflow-y-auto  w-full relative" v-if="content.items && !showWizard">
                <div class="px-4 mb-6 py-4 rounded-lg shadow-md bg-white dark:bg-gray-700 flex w-full">
                    ...
                    <a href="javascript:;" v-if="!showWizard" class="uppercase p-2 mx-2 text-center text-white w-32 rounded-lg bg-danger" @click="addSupervisorWizard" v-text="translate('add_new')"></a>
                </div>
                <hr class="mt-2" />
...
import supervisor_wizard from '@/components/wizards/supervisorWizard.vue';
         ...
         */  
         const handleAction =  (actionName, data) =>  {
            switch(actionName) 
            {
                ...
                case 'delete':
                    deleteByKey('route_id', data, 'Supervisor.delete');
                    break;  
