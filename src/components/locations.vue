    ...
    <div class="w-full flex overflow-auto" style="height: 85vh; z-index: 9999;">
        <div class=" w-full">
            ...
            <main v-if="content && !showLoader" class="relative flex-1 overflow-x-hidden overflow-y-auto  w-full">
                <maps @update-marker="updatedLocation" @click-marker="updatedLocation" v-if="locations.length" :key="locations" :center="locations[0] ? locations[0].destination : {lat:0, lng: 0}" :waypoints="locations"></maps>
