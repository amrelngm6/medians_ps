                    ...
                    <div class="modal-body mx-5 mx-xl-15 my-7"  v-if="wallet">
                        ...
                        <div class="d-flex text-center mb-9 ">
                            ...
                            <div class="w-50 border border-dashed border-gray-300 rounded mx-2 p-4">
                                ...
                                <div class="fs-2 fw-bold" kt-modal-adjust-balance="current_balance" v-text="currency.symbol+''+(wallet.debit_balance ?? '0')"></div>
                            </div>
                        </div>
                        <!--end::Balance preview-->
                ...
                <div class="card-body pb-0">
                    ...
                    <div class="d-flex justify-content-between pb-6">
                        <div class="w-full">
                            ...
                            <p v-text="translate('Credit balance used for commissions')"></p>
                            <p v-text="translate('Debit balance used for collected amount from cash trips')"></p>
                        </div>
                        <div class="d-flex flex-wrap">
                            <div class="border border-dashed border-gray-300 w-125px rounded my-3 p-4 me-6">
                                <span class="fs-2x fw-bold text-gray-800 lh-1" v-if="wallet">
                                    <span
                                        v-text="wallet ? (currency.symbol + '' + (wallet.credit_balance ?? '0')) : '0'"></span>
                                </span>
