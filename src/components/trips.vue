                            ...
                            <div  class="w-full grow shrink basis-0 px-6 py-4 flex-col justify-center items-start gap-4 inline-flex" v-if="trip.vehicle">
                                ...
                                <div class="w-full relative flex">
                                    <div class="w-full relative">
                                        ...
                                        <span class="bottom-2 absolute pt-2" :style="(lang.lang == 'en' ? 'left: ' : 'right: ') +((20 * trip.pickup_locations.length) + 20)+'px'"><i class="fa fa-location-dot text-sm"></i> <span class="font-semibold  px-1" v-if="trip.pickup_locations" v-text="filterLocations(trip.pickup_locations, 'waiting').length"></span></span>
                                    </div>
                                    <div class="w-full relative">
                                        ...
                                        <span class="bottom-2 absolute pt-2" :style="(lang.lang == 'en' ? 'left: ' : 'right: ') +((20 * trip.pickup_locations.length) + 20)+'px'"><i class="fa fa-location-dot text-sm"></i> <span class="font-semibold  px-1" v-if="trip.pickup_locations" v-text="filterLocations(trip.pickup_locations, 'moving').length"></span></span>
                                    </div>
