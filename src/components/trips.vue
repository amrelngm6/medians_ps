<template>
    <div class="w-full flex overflow-auto" style="height: 85vh; z-index: 9999;">
        ...
        <div  v-if="content && !showTrip " class=" w-full relative">
            ...
            <maps :center="locations.length > 0 ? {lat: locations[0], lng:locations[0]} : {lat: 0, lng:0}" @click-marker="clickMarker" @update-marker="updateMarker" :showroute="true" :waypoints="locations" @interval-callback="callback"></maps>
