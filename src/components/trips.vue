...
export default 
{
    ...
    methods: 
    {
        ...
        setLocationsPickups(trip)
        {
            ...
            this.locations[locations.length] = {drag:true, icon: this.conf.url+'uploads/images/destination.svg', origin: { lat: 0, lng: 0 }, destination: { lat: parseFloat(trip.route.latitude), lng: parseFloat(trip.route.longitude) } }
