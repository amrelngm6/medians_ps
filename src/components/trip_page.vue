            ...
            <div class="xl:col-span-3 lg:col-span-5">
                <div class="card px-4 py-6 mb-6">
                    <div class="text-center" v-if="activeItem && activeItem.driver">
                        ...
                        <button type="button" @click="close" class=" hover:bg-primary mb-3 px-6 py-2 flex text-danger gap gap-6"><close_icon class="w-8" /> <span v-text="translate('Back')"></span></button>
                    </div>
