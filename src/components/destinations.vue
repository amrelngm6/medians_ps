    ...
    <div class="w-full flex overflow-auto" style="height: 85vh; z-index: 9999;">
        <div class=" w-full">
            ...
            <main v-if="content && !showLoader" class="relative flex-1 overflow-x-hidden overflow-y-auto  w-full">
                <maps :showroute="false" @update-marker="updateMarker" @click-marker="clickMarker" :setting="setting" v-if="locations.length" :key="center" :center="center" :waypoints="locations"></maps>
