<template>
    <div class="w-full" >
        ...
        <div class="relative w-full h-full  pt-2" v-if="!showLoader && activeItem && !showConfirm && (!activeItem.status || activeItem.status == 'active')">
            ...
            <div class="pt-8 mt-12 relative mx-auto w-full bg-white p-6 rounded-lg overflow-y-auto" style="max-width: 600px; max-height: 500px;" >
                ...
                <div class="w-full block gap-4 py-2 border-b  border-gray-200">
                    ...
                    <div class="w-full flex mt-10">
                        <div @click="setShowConfirm()" v-if="activeItem.id" class="cursor-pointer absolute left-0 top-4 ml-4 ">
