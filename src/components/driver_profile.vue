                                    ...
                                    <div class="w-full border-b border-gray-100" v-if="activeStatus == 'info'">
                                        <div class="row mt-6 w-full">
                                            ...
                                            <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 mb-6">
                                                <dashboard_card_white  icon="/uploads/img/booking-unpaid.png" classes="bg-gradient-danger" :title="__('Completed trips')" :value="activeItem.last_trips.length"></dashboard_card_white>
