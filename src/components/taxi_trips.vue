                    ...
                    <datatabble 
                        ...
                        <template #item-model="item">
                            <div class="w-full relative flex gap-2">
                                <img  class="rounded-full w-8 h-8 rounded-[50px] border-2 border-purple-800" :src="(item.model && item.model.picture) ? item.model.picture : '/uploads/images/default_profile.png'" /> 
