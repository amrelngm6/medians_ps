...
class LangsAr
{
	...
	public static function get()
	{
		...
		,'Private Trips description' => 'قائمة بالرحلات الخاصة التم تم حجزها مباشرة'
		...
		,'Drivers applicants note' => 'يمكنك تفعيل أة إلغاء عملك من استلام <b>متقدمين كسائقين</b>. <br /لتغيير ذلك من صفحة إدارة العمل'
		...
		,'gateway' => 'بوابة الدفع'
		,'Allow private trips' => 'السماح بالرحلات الخاصة'
		,'plan name' => 'إسم الخطة'
		,'limit' => 'الحد الاقصي'
		,'from' => 'من'
		,'to' => 'إلي'
		...
		,'This email used for view at your profile, but for notifications we use the Admin email' => 'هذا البريد يستخدم للعرض علي صفحتك الشخصية, اما التنبيهات يتم ارسالها الي بريد الحساب الشخصي'
		,'' => ''
