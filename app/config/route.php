...
Macaw::get('/check_new_notifications', \Medians\Messages\Application\MessageController::class.'@check_new_notifications');
...
if(isset($app->auth()->id))
{
    ...
    {
        $end = (new \Medians\Auth\Application\AuthService)->unsetSession();
        echo $end ? (new \config\APP)->redirect('./') : '';
    });
