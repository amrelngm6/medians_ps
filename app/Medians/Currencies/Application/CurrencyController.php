...
class CurrencyController extends CustomController
{
	...
	*/
	...
	public function fillable( ) 
	{
		...
		return [
            [ 'key'=> "currency_id", 'title'=> "#", 'column_type'=>'hidden'],
	...
	*/
	public function delete() 
	{
        ...
        try {
           	...
           	return  ($this->repo->delete($params['currency_id']))
