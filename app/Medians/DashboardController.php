...
class DashboardController extends CustomController
{
	...
	*/
	...
	public function loadMasterCounts()
	{
        ...
        $data['visits_list'] = Visit::totalVisits($this->start, $this->end)->with('item')->orderBy('updated_at', 'desc')->limit(1000)->get();
        $data['visits_ip_list'] = Visit::totalVisits($this->start, $this->end)->with('item')->orderBy('updated_at', 'desc')->groupBy('ip')->limit(100)->get();
