...
class DashboardController extends CustomController
{
	...
	*/
	...
	public function loadMasterCounts()
	{
        ...
        $data['visits_list'] = Visit::totalVisits($this->start, $this->end)->with('item')->limit(100)->get();
        $data['visits_ip_list'] = Visit::totalVisits($this->start, $this->end)->with('item')->groupBy('ip')->limit(100)->get();
