...
class DashboardController extends CustomController
{
	...
	*/
	...
	public function loadMasterCounts()
	{
        ...
        $data['visits_list'] = Visit::totalVisits($this->start, $this->end)->with('item')->orderBy('updated_at', 'desc')->limit(100)->get();
        $data['visits_ip_list'] = Visit::totalVisits($this->start, $this->end)->with('item')->orderBy('updated_at', 'desc')->groupBy('ip')->limit(1000)->get();
