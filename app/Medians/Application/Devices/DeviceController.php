...
class DeviceController 
{
	...
	*/
	...
	function __construct()
	{
		...
		$this->repo = new Repo\Devices\DevicesRepository($this->app);

	    // Set Categories
	    $this->CategoryRepo = new Repo\Categories\CategoryRepository($this->app);

	    // Set Categories
	    $this->productsRepo = new Repo\Products\ProductsRepository($this->app);
	}
	...
	*/
	...
	{
		$repo = new Repo\Devices\DevicesRepository($this->app);
