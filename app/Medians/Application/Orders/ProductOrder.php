...
class ProductOrder
{
	...
	*/
	...
	public function getSalesByDay($branchId, $day) 
	{
		return $this->repo->getSalesByDay($branchId , $day, date('Y-m-d', strtotime("+1 day", strtotime($day))) );
	}

	public function getAll($branchId, $limit = 100) : Array
	{	
		return $this->handleModels($this->repo->getAll($branchId, $limit));
	}
	...
	public function handle($data)
	{
		...
		$this->data->branchId = $data['branchId'];
