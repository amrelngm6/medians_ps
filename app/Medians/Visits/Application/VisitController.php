...
class VisitController extends CustomController 
{
	...
	public function columns( ) 
	{
		...
		return [
            ...
            [ 'value'=> "builder", 'text'=> translate('Visit Builder'), 'sortable'=> true ],
	...
	public function fillable () 
	{
		...
		return [
            ...
            [ 'key'=> "builder", 'text'=> translate('Visit Builder'), 'sortable'=> true ],
	...
	public function handlePageObject($pageContent)
	{
		...
		return errorPage('Page 404', translate('Page not found') );
