...
class AgentController extends CustomController 
{
	...
	*/
	...
	public function getAgent()
	{
		...
		$data =  $this->repo->getAgent($this->app->auth()->customer_id);
	...
	*/
	...
	/**
	 * Agent Login through Mobile API
	 */
	public function login()
	{
		$Auth = new \Medians\Auth\Application\AuthService;
		$repo = new \Medians\Customers\Infrastructure\AgentRepository(null);
	...
	public function loginWithGoogle() 
	{
		...
		$customer = $this->repo->findAgentByEmail($tokenInfo->email);
		if (empty($customer))
		{
			try {
	...
	public function loginWithTwitter() 
	{
		...
		$customer = $this->repo->findAgentByEmail($params['email']);
		if (empty($customer))
		{
			try {
				$pictureName = rand(999999, 999999).date('Ymdhis').'.jpg';
