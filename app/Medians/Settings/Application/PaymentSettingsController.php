	...
	*/
	...
	public function fillable( ) 
	{
		...
		return [
			...
			'paypal'=> [	
				[ 'key'=> "paypal_payment", 'title'=> translate('Allow Paymment  with PayPal'), 'help_text'=>translate('Allow users to pay with PayPal for plan subscriptions'), 'fillable'=> true, 'column_type'=>'checkbox' ],
			...
			'paystack'=> [
				[ 'key'=> "paystack_payment", 'title'=> translate('Allow Paymment  with paystack'), 'help_text'=>translate('Allow users to pay with paystack for plan subscriptions'), 'fillable'=> true, 'column_type'=>'checkbox' ],
			...
			'pagadito'=> [
				[ 'key'=> "pagadito_payment", 'title'=> translate('Allow Paymment  with pagadito'), 'help_text'=>translate('Allow users to pay with pagadito for plan subscriptions'), 'fillable'=> true, 'column_type'=>'checkbox' ],
