	...
	*/
	...
	public function fillable( ) 
	{
		...
		return [
			...
			'drivers'=> [	
				[ 'key'=> "driver_comission", 'title'=> translate('Driver commission for Private trips'), 'help_text'=> translate('The drivers commission when they complete paid private trip. The commission amount will be added to driver wallet balance'), 'fillable'=> true, 'column_type'=>'number' ],
