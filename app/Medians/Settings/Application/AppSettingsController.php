	...
	public function fillable( ) 
	{
		...
		return [
			...
			'Social media login'=> [	
				...
				[ 'key'=> "twitter_redirect_link", 'title'=> translate('Twitter Redirect callback'), 'help_text'=> translate('Redirect should be scheme like (mediansagents://callback)'), 'fillable'=> true, 'column_type'=>'text' ],
            ],
