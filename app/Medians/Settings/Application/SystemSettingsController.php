	...
	public function fillable( ) 
	{
		...
		return [
			...
			'wallets'=> [	
				...
				[ 'key'=> "comission_paid_plan", 'help_text'=>'Comission will be calculated on withdrawal request', 'title'=> __('Commission for paid plan subscribers'), 'fillable'=> true, 'column_type'=>'number' ],
			],
