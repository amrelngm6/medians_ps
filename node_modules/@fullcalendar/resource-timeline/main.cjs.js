...
var timelinePlugin = require('@fullcalendar/timeline');
...
var SpreadsheetIndividualCell = /** @class */ (function (_super) {
    ...
    SpreadsheetIndividualCell.prototype.render = function () {
        ...
        return (common.createElement(common.MountHook, { hookProps: hookProps, didMount: colSpec.cellDidMount, willUnmount: colSpec.cellWillUnmount }, function (rootElRef) { return (common.createElement("td", { ref: rootElRef, role: "gridcell", "data-resource-id": props.resource.id, className: [
                'fc-datagrid-cell',
                'fc-resource',
...
var SpreadsheetGroupCell = /** @class */ (function (_super) {
    ...
    SpreadsheetGroupCell.prototype.render = function () {
        ...
        common.createElement("td", { ref: rootElRef, role: "gridcell", rowSpan: props.rowSpan, className: ['fc-datagrid-cell', 'fc-resource-group'].concat(classNames).join(' ') },
...
var SpreadsheetRow = /** @class */ (function (_super) {
    ...
    SpreadsheetRow.prototype.render = function () {
        ...
        return (common.createElement("tr", { role: "row" }, props.colSpecs.map(function (colSpec, i) {
...
var SpreadsheetGroupRow = /** @class */ (function (_super) {
    ...
    SpreadsheetGroupRow.prototype.render = function () {
        ...
        return (common.createElement("tr", { role: "row" },
            common.createElement(common.RenderHook, { hookProps: hookProps, classNames: spec.labelClassNames, content: spec.labelContent, defaultContent: renderCellInner, didMount: spec.labelDidMount, willUnmount: spec.labelWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("th", { ref: rootElRef, 
...
var SpreadsheetHeader = /** @class */ (function (_super) {
    ...
    SpreadsheetHeader.prototype.render = function () {
        ...
        if (superHeaderRendering) {
            ...
            rowNodes.push(common.createElement("tr", { key: "row-super", role: "row" },
                common.createElement(common.RenderHook, { hookProps: hookProps, classNames: superHeaderRendering.headerClassNames, content: superHeaderRendering.headerContent, didMount: superHeaderRendering.headerDidMount, willUnmount: superHeaderRendering.headerWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("th", { ref: rootElRef, role: "columnheader", scope: "colgroup", colSpan: colSpecs.length, className: [
                        'fc-datagrid-cell',
        ...
        rowNodes.push(common.createElement("tr", { key: "row", role: "row" }, colSpecs.map(function (colSpec, i) {
            var isLastCol = i === (colSpecs.length - 1);
            // need empty inner div for abs positioning for resizer
            return (common.createElement(common.RenderHook, { key: i, hookProps: hookProps, classNames: colSpec.headerClassNames, content: colSpec.headerContent, didMount: colSpec.headerDidMount, willUnmount: colSpec.headerWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("th", { ref: rootElRef, role: "columnheader", className: ['fc-datagrid-cell'].concat(classNames).join(' ') },
...
var ResourceTimelineLanes = /** @class */ (function (_super) {
    ...
    ResourceTimelineLanes.prototype.render = function () {
        var _a = this, props = _a.props, context = _a.context;
        return (common.createElement("table", { ref: this.rootElRef, "aria-hidden": true, className: 'fc-scrollgrid-sync-table ' + context.theme.getClass('table'), style: {
        ...
        var sections = [
            {
                ...
                chunks: [
                    ...
                    {
                        key: 'divider',
                        outerContent: (common.createElement("td", { role: "presentation", className: 'fc-resource-timeline-divider ' + context.theme.getClass('tableCellShaded') })),
                    },
                    {
                        key: 'timeline',
