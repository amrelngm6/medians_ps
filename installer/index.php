...
<head>
    ...
    <!-- Font Icon -->
    <link rel="stylesheet" href="/installer/vendor/nouislider/nouislider.min.css">

    <!-- Main css -->
    <link rel="stylesheet" href="/installer/css/style.css">
</head>
...
<body>
    ...
    <div class="main">
        ...
        <div class="container">
            <form method="POST"  class="signup-form" id="signup-form" action="/installer/install.php">
                <div>
    ...
    <!-- JS -->
    <script src="/installer/vendor/jquery/jquery.min.js"></script>
    <script src="/installer/vendor/jquery-validation/dist/jquery.validate.min.js"></script>
    <script src="/installer/vendor/jquery-validation/dist/additional-methods.min.js"></script>
    <script src="/installer/vendor/jquery-steps/jquery.steps.min.js"></script>
    <script src="/installer/vendor/minimalist-picker/dobpicker.js"></script>
    <script src="/installer/vendor/nouislider/nouislider.min.js"></script>
    <script src="/installer/vendor/wnumb/wNumb.js"></script>
    <script src="/installer/js/main.js"></script>
</body>
